# The lambda_function.py stores all the functions needed to run the app, starting from defining the interpreter,
# receiving the input image, preprocessing the image, and use the saved model to make the prediction.
